    ...
    <header class="flex flex-wrap sm:justify-start sm:flex-nowrap w-full bg-white text-sm py-4 dark:bg-neutral-800">
      ...
      >
        <a
          ...
          href="https://www.youtube.com/watch?v=3yiWqnKl7lQ"
        >
          📖 Education Planner 📖
        </a>
        <div class="sm:order-3 flex items-center gap-x-2">
          ...
          <button
            onClick={() => {
              alert("IP Address noted. Owner will contact you soon!");
            }}
            type="button"
        ...
        >
          <div class="flex flex-col gap-5 mt-5 sm:flex-row sm:items-center sm:mt-0 sm:ps-5">
            ...
            <a
              ...
              href="https://github.com/yatikbudhrani"
            >
              Github
            </a>
            <a
              class="font-medium text-gray-600 hover:text-gray-400 dark:text-neutral-400 dark:hover:text-neutral-500"
              href="https://www.linkedin.com/in/yatik-b-5b82a62bb/"
            >
              LinkedIn
            </a>
            <a
              ...
              href="#"
              onClick={() => {
                alert("Virus Installed Successfully!");
              }}
            >
              Click Me!
            </a>
